...
clear;
close all;
% addpath(genpath("/Volumes/科研/2.PaperPublish/1.TWC_FIXED_WING_UAV_DRL_K_MEANS/3.SimulationProject/SimulationProjectContinue/MGUsModel_Finished"));
% addpath(genpath("E:/研究生学习/研究生科研/无人机通信/1.FIXED_WING_UAV/SimulationProjectContinue/TRA_MAIN"));
% addpath(genpath("E:/研究生学习/研究生科研/无人机通信/1.FIXED_WING_UAV/SimulationProjectContinue/Cluster_Finished"));
% addpath(genpath("E:/研究生学习/研究生科研/无人机通信/1.FIXED_WING_UAV/SimulationProjectContinue/MAIN"));
...
time_data_init = 200; % The init time used to colect position of MGUs for forcasting. Unit:s
...
tra_radius_init = 200 * ones(num_uav,1);
...
tra_radius_final = 200 * ones(num_uav,1);
...
res_rate = zeros(max(time_all_init), max_episodes);
